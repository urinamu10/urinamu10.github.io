...
- 오늘 배운 내용을 깔끔하게 정리하고 발생했던 문제에서 해결방법까지 논리순서대로 정렬
...
![alt text](/assets/img/mage-1.png)
...
1. 그리고 확인 메시지를 요청하지않은 사용자는 `0`으로 처리해야하므로
...
![alt text](/assets/img/mage-2.png)
...
1. 판매된 단위가 전혀 없는 제품이라면 평균 판매 가격은 0으로 지정
...
1. 또한 판매 된 날짜가 판매시작,끝 날짜 사이에 있어야하므로 `between` 함수를 사용합니다.
...
![alt text](/assets/img/mage-3.png)
...
![alt text](/assets/img/mage-4.png)
...
![alt text](/assets/img/mage-5.png)
...
![alt text](/assets/img/mage-6.png)
...
![alt text](/assets/img/mage-7.png)
...
![alt text](/assets/img/mage-8.png)
...
![alt text](/assets/img/mage-9.png)
...
![alt text](/assets/img/mage-10.png)
...
![alt text](/assets/img/mage-15.png)
...
![alt text](/assets/img/mage-16.png)
...
![alt text](/assets/img/mage-17.png)

만약 두개 이상의 조건이 필요할땐 한가지의 조건 다음에 **&(AND) ,  | (OR)** 등 논리 연산자를 이용해 다중조건을 걸어줄 수 있습니다.

- DataFrame에서 전체 행의 30%를 임의로 랜덤 샘플링

```python
df.sample(frac=0.5)
```

![alt text](/assets/img/mage-18.png)
...
![alt text](/assets/img/mage-19.png)
...
![alt text](/assets/img/mage-20.png)
...
![alt text](/assets/img/mage-21.png)
...
![alt text](/assets/img/mage-22.png)
...
![alt text](/assets/img/mage-23.png)
...
![alt text](/assets/img/mage-24.png)
...
![alt text](/assets/img/mage-25.png)
...
![alt text](/assets/img/mage-26.png)
...
![alt text](/assets/img/mage-27.png)
...
![alt text](/assets/img/mage-28.png)
...
![alt text](/assets/img/mage-29.png)
...
1. **다음 코드로 생성된 DataFrame** `df`**가 있을 때, 'a' 컬럼 값이 5이거나 ('a' == 5) 'c' 컬럼 값이 12인 행만 선택하는 코드로 올바른 것은 무엇인가요?**
...
1. **학습 노트에서 제시된 멀티 인덱스 DataFrame** `df`**가 있다고 가정하고, 'c' 컬럼에 존재하는 **결측치(NaN)**의 총 개수를 계산하는 올바른 코드는 무엇인가요? ('c' 컬럼 값은 [10, 11, 12, np.nan, 12] 입니다.)**
